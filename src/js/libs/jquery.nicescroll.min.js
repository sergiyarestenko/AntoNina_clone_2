        ...
        this.init = function () {
            ...
            */
            ...
            if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
                ...
                if (self.win.hasClass('gt-scroll-cursor-custom')) {
                    cursor.addClass('gt-scroll-cursor');
                }
      self.win.attr('data-scroll',self.id)
                cursor.css({
...
//
        ...
        this.onResize = function (e, page) {
            ...
            self.cursorheight = Math.max(self.opt.cursorminheight, self.cursorheight / 2);
